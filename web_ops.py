...
def get_authors(paper_id,page,i,driver,is_debug=False):
...
def get_authors_proxy(paper_id,page,i,driver,is_debug=False):
    ...
    try:
        proxyAddr = "103.122.179.178:38845"
        authKey = "7F2B4D16"
        ...
        # authkey = ''
        # authpwd = ''
        # exxx = f"http://{authkey}:{authpwd}@隧道地址 {url}"
